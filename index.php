...
?>
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="graph.php" onclick=$("#menu-close").click();>Health Graph</a>
            </li>
            ...
            <div class="row text-center">
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="row">
						...
						Roti:<input type="number" id="roti1" name="roti1" placeholder="count" ><br><br>
						Rice:<input type="number" id="rice1" name="rice1" placeholder="small bowls" ><br><br>
								...
								<div class="checkbox">
									<label><input type="checkbox" value="yes" id="salat1" name="salat1">I had Salat</label>
								</div>
							</div>
						</div>
                        <div class="col-md-3 col-sm-3 col-xs-3">
					...
					Roti:<input type="number" id="roti2" name="roti2" placeholder="count"><br><br>
					Rice:<input type="number" id="rice2" name="rice2" placeholder="small bowls"><br><br>
								<label for="sel1">Along with:</label>
								...
								<div class="checkbox">
									<label><input type="checkbox" value="yes" id="salat2" name="salat2">I had Salat</label>
								</div>
							</div>
                        </div>
                    </div>
					<button onclick="funFun()" class="btn btn-info" data-toggle="modal" data-target="#thisDiv" value="submit">Submit</button>
				
                </div>
            </div>
        </div>
    </section>
   <div class="modal fade" id="thisDiv" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;"></div>
        <div id="dataFromCal" class="modal-body" style="padding:40px 50px;">
    ...
    <script>
        function funFun(){
            console.log("hahaha");
            var bfast1 = document.getElementById('bfast1').value;
            var bfast2 = document.getElementById('bfast2').value;
            var bfast3 = document.getElementById('bfast3').value;
            var snack1 = document.getElementById('snack1').value;
            var snack2 = document.getElementById('snack2').value;
            var snack3= document.getElementById('snack3').value;
            var roti1= document.getElementById('roti1').value;
            var roti2= document.getElementById('roti2').value;
            var rice1= document.getElementById('rice1').value;
            var rice2= document.getElementById('rice2').value;
            var sabzi1= document.getElementById('sabzi1').value;
            var sabzi2= document.getElementById('sabzi2').value;
            var salat1= document.getElementById('salat1').value;
            var salat2= document.getElementById('salat2').value;
            
            $.post("caloriecalc.php",
                {
                    'bfast1':bfast1,
                    'bfast2':bfast2,
                    'bfast3':bfast3,
                ...
                function(data,status){
                    document.getElementById('dataFromCal').innerHTML = data;
                }
            );
        }
    </script>
