...
?>	
        ...
        <?php if(bmn()<18.9) {?>
			<center><h3>You are Underweight according to your BMI.<br> 
		<?php }elseif(bmn()>24.5){ ?>
			<center><h3>You are Overweight according to your BMI.<br>
		<?php }else{ ?>	
			<center><h3>You are Healthy according to your BMI.<br>
		<?php } ?>
			<center><h2>About Today's Meal</h2></center>
		<?php if(abs($rec-$cal)<75){ ?>
			<h3>Your diet is healthy for you.<br>Your mistake value is <?php echo $mistake; ?> out of 100.</h3></center>
